...
public class TavaresAdditionsModBiomes {
	@SubscribeEvent
		...
		for (LevelStem levelStem : levelStemTypeRegistry.stream().toList()) {
			...
			if (dimensionType.is(BuiltinDimensionTypes.OVERWORLD)) {
				...
				if (chunkGenerator instanceof NoiseBasedChunkGenerator noiseGenerator) {
					((TavaresAdditionsModNoiseGeneratorSettings) (Object) noiseGenerator.settings.value()).settavares_additionsDimensionTypeReference(dimensionType);
				}
			}
		}
	}
	...
	private static SurfaceRules.RuleSource injectOverworldSurfaceRules(SurfaceRules.RuleSource currentRuleSource) {
		...
		customSurfaceRules.add(anySurfaceRule(ResourceKey.create(Registries.BIOME, new ResourceLocation("tavares_additions", "biolumen_cave")), TavaresAdditionsModBlocks.DENSE_SANDSTONE.get().defaultBlockState(),
				TavaresAdditionsModBlocks.DENSE_SANDSTONE.get().defaultBlockState(), TavaresAdditionsModBlocks.DENSE_SANDSTONE.get().defaultBlockState()));
	...
	public interface TavaresAdditionsModNoiseGeneratorSettings {
		void settavares_additionsDimensionTypeReference(Holder<DimensionType> dimensionType);
	}
}