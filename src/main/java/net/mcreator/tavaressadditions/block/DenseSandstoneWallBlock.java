...
public class DenseSandstoneWallBlock extends WallBlock {
	public DenseSandstoneWallBlock() {
		super(BlockBehaviour.Properties.of()
				...
				.strength(1.5f, 6f).requiresCorrectToolForDrops().noOcclusion().isRedstoneConductor((bs, br, bp) -> false).instrument(NoteBlockInstrument.SNARE).forceSolidOn());
	}
}